...
<style>
    ...
    .draft-btn:hover { background: #e5e7eb; }
...
<div class="create-grid">
    ...
    <div>
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form method="POST" action="/admin/blogs" enctype="multipart/form-data" id="blog-form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            id="desc-input"
                            placeholder="Write a brief summary that appears on blog cards"
                            maxlength="300"
                    ...
                    <div class="form-group">
                        ...
                        <div class="editor-wrapper">
                            ...
                            <div id="editor-toolbar">
                                ...
                                <div class="toolbar-group">
                                    <button type="button" onclick="execCmd('justifyLeft')"   title="Align Left">L</button>
                                    <button type="button" onclick="execCmd('justifyCenter')" title="Center">C</button>
                                    <button type="button" onclick="execCmd('justifyRight')"  title="Align Right">R</button>
                                    <button type="button" onclick="execCmd('justifyFull')"   title="Justify">J</button>
                                </div>

                                <div class="toolbar-group">
                                    <button type="button" onclick="execCmd('insertUnorderedList')" title="Bullet List">UL</button>
                                    <button type="button" onclick="execCmd('insertOrderedList')"   title="Numbered List">OL</button>
                                ...
                                <div class="toolbar-group">
                                    ...
                                    <button type="button" onclick="removeLink()"    title="Remove Link">-Link</button>
                                    ...
                                    <button type="button" onclick="insertInlineCode()" title="Inline Code">Code</button>
                                </div>
                            ...
                            <div id="content-editor" contenteditable="true">{{ old('content') }}</div>
    ...
    <div>
        ...
        <!-- Publish Card -->
        <div class="side-card">
            <div class="side-card-header">Publish</div>
            <div class="side-card-body">
                <button type="submit" form="blog-form" class="publish-btn">Publish Blog</button>
                <a href="/admin/dashboard" class="draft-btn">Cancel</a>
            </div>
        </div>
